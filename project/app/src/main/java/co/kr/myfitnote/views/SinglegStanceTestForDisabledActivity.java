...
import co.kr.myfitnote.model.SingLegStanceDisabled;
...
public class SinglegStanceTestForDisabledActivity extends AppCompatActivity implements View.OnClickListener, SendEventListener {
    ...
    private SingLegStanceDisabled singLegStance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singleg_stance_test_for_disabled);
        Log.e("poapo","start =====");
...
//        user = gson.fromJson(userData, User.class);
        ...
        singLegStance = new SingLegStanceDisabled();
        ...
        ReadyFragment readyFragment = new ReadyFragment("외발서기","지금부터 ㅎㅎㅎㅎㅎㅎㅎ.");
...
//            managerFragment.getCurrentFragment().setArguments(bundle);
    ...
    public void restart() {
        ...
        singLegStance.setStatus(SingLegStanceDisabled.EXERCISE_READY);
