 ...
 * 설명영상 프래그먼트
 */
public class GaitSpeedVideoFragment extends Fragment implements SurfaceHolder.Callback, View.OnClickListener{
    ...
    public GaitSpeedVideoFragment(String title, String videoUri){
        this.title = title;
        this.videoUri = videoUri;
    }

    public GaitSpeedVideoFragment(String title, String videoUri, int timer){
        this.title = title;
        this.videoUri = videoUri;
        this.timer = timer;
    }
    ...
    //게임용 프로그먼트 생성자
    public GaitSpeedVideoFragment(String title, String videoUri, int containerBackgroundColor, int buttonBackgroundColor, int timer){
        this.title = title;
        this.videoUri = videoUri;
