...
public class PoseGraphic extends GraphicOverlay.Graphic {
  ...
  private static final float DOT_RADIUS = 18.0f;
  ...
  private int drawSkeletonType = 1;
  ...
  public PoseGraphic(
    ...
    this.drawSkeletonType = drawSkeletonType;

    this.poseClassification = new ArrayList<>();
