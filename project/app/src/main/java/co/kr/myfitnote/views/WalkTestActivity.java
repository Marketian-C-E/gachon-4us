...
public class WalkTestActivity extends AppCompatActivity implements View.OnClickListener, SendEventListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walk_test);
        Log.e("poapo","start =====");

        // fragment 등록
        managerFragment = new ManagerFragment();
//        managerFragment.add(new ExplanationVideoFragment("심폐기능검사", "http://nfa.kspo.or.kr/common/site/www/front/movie_zip/kind4_9/kind4_9.mp4",120)); // index: 4
        managerFragment.add(new ExplanationVideoFragment("심폐기능검사", "walk",120)); // index: 4
        managerFragment.add(new ExplanationTextFragment("심폐기능검사","지금부터 심폐기능검사를 시작합니다. \n \"바른자세로 3초간 서 주세요\" "));
        managerFragment.add(new  TestStartedFragment("심폐기능검사"));
        managerFragment.add(new TestResultFragment());
...
//        getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout, managerFragment.getCurrentFragment()).commit();
    ...
    public void startCamera() {
        ...
        cameraHelper.setOnCameraStartedListener(
                surfaceTexture -> {
                    Log.e("poapo","camera start==");
                    onCameraStarted(surfaceTexture);
                });
        CameraHelper.CameraFacing cameraFacing = CAMERA_FACING;
        cameraHelper.startCamera(
                this, cameraFacing, /*unusedSurfaceTexture=*/ null);
