...
public class RegisterViewModel extends BaseObservable implements DatePicker.OnDateChangedListener, RadioGroup.OnCheckedChangeListener {
    private User user;
...
//                    ((Activity) (this.context)).finish();
    ...
    private boolean validate(){
        ...
        if (user.getPhone().equals("")) {
            Toast.makeText(this.context, "연락처를 입력해 주세요.", Toast.LENGTH_LONG).show();
            return false;
        }
